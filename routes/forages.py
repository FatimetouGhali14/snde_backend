...
STATUTS_FORAGE = [
    ...
    "En rebobinage", "En attente de pièces", "Hors service"
]
...
FORAGES_SNDE = [
    ...
    {"nom": "Forage Rosso", "site": "Rosso", "brigade": "Département Eaux de Surface", "lat": 16.51, "lng": -15.81},
    ...
    {"nom": "Forage Tekane", "site": "Tekane", "brigade": "Département Eaux de Surface", "lat": 16.62, "lng": -15.17},
]
...
def get_forage(forage_id):
    ...
    return jsonify({"data": forage}), 200
...
def get_statuts_forage():
    return jsonify({"data": STATUTS_FORAGE}), 200
